...
namespace TASMOps.Model
{
    ...
    public class CSPAccountCreds
    {
        ...
        /// </summary>
        public string CSPPartnerCenterAppId { get; set; }

        /// <summary>
        /// Gets or sets the Tenant Id or Microsoft Id for the CSP Partner.
        /// </summary>
        public string CSPPartnerTenantID { get; set; }
        ...
        /// </summary>
        public string CSPARMNativeAppId { get; set; }
        ...
        /// </summary>
        public string CSPLocale { get; set; }
    }
}
